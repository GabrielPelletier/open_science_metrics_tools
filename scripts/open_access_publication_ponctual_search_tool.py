...
if __name__ == '__main__':
    ...
    base_query = 'AND ("Montreal Neurological"[Affiliation] OR "McGill"[Affiliation]) AND 2024/01/01:2024/12/31[Date - Publication])'
    # Read QUERY, or AUTHOR LIST, from text file
    text_file = open(ROOT_DIR + "/data/queries_and_lists_for_ponctual_searches/neuro_author_list_2024.csv", "r", encoding='utf-8')
