...
for line in data[1:]:
    ...
    if row[7] == 'closed':
        ...
        oa_text = '<img src=' + oa_logo_link + ' alt="drawing" width="40" align="left"/> &nbsp This publication is available in <strong>Open Access</strong>! (Gold OA)\n\n' + \
                  '&nbsp;&nbsp;&nbsp;[Access it freely here](' + row[9] + ')\n'
    elif row[7] == 'hybrid':
        oa_text = '<img src=' + oa_logo_link + ' alt="drawing" width="40" align="left"/> &nbsp This publication is available in <strong>Open Access</strong>! (Hybrid OA)\n\n' + \
                  '&nbsp;&nbsp;&nbsp;[Access it freely here](' + row[9] + ')\n'
    elif row[7] == 'green':
        oa_text = '<img src=' + oa_logo_link + ' alt="drawing" width="40" align="left"/> &nbsp This publication is available in <strong>Open Access</strong>! (Green OA)\n\n' + \
                  '&nbsp;&nbsp;&nbsp;[Access it freely here](' + row[9] + ')\n'
    elif row[7] == 'bronze':
        oa_text = '<img src=' + oa_logo_link + ' alt="drawing" width="40" align="left"/> &nbsp This publication is available in <strong>Open Access</strong>! (Bronze OA)\n\n' + \
                  '&nbsp;&nbsp;&nbsp;[Access it freely here](' + row[9] + ')\n'
